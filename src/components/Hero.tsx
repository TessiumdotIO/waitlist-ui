        ...
        <div className="order-2 md:order-1">
          ...
          <FadeIn direction="up" delay={500}>
            <p className="text-lg text-muted-foreground mb-8 max-w-lg">
              Join Learniverse, the premier learn-to-earn platform where knowledge acquisition
              translates directly to valuable rewards. Master blockchain concepts while earning tokens.
            </p>
          </FadeIn>
          ...
          <FadeIn direction="up" delay={900}>
            <div className="mt-12 flex items-center gap-6">
              ...
              <p className="text-sm text-muted-foreground">
                <span className="font-medium text-foreground">1,200+</span> users already on the waitlist
              </p>
            </div>
          </FadeIn>
        </div>
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                ...
                <div className="absolute -bottom-4 -right-4 sm:bottom-12 sm:right-0 w-40 h-40 rounded-lg rotate-6 neo-blur flex items-center justify-center">
                  <div className="text-center p-4">
                    <div className="font-bold text-xl">250 LRNT</div>
                    <div className="text-xs text-muted-foreground mt-1">Tokens Earned</div>
                  </div>
                </div>
                ...
                <div className="absolute -top-4 -left-4 sm:top-12 sm:left-0 w-40 h-40 rounded-lg -rotate-6 neo-blur flex items-center justify-center">
                  <div className="text-center p-4">
                    ...
                    <div className="text-xs text-muted-foreground mt-1">XP Points</div>
                  </div>
                </div>
              </div>
            </div>
