    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center space-x-6">
          <a href="#features" className="subtle-underline font-medium">Features</a>
          <a href="#how-it-works" className="subtle-underline font-medium">How It Works</a>
          <a href="#about" className="subtle-underline font-medium">About</a>
        </nav>
        
        <div className="hidden md:flex items-center space-x-4">
          <Button className="bg-primary/10 text-primary hover:bg-primary/20" variant="ghost">
            Login
          </Button>
      ...
      <div 
        className={cn(
          ...
          mobileMenuOpen ? "top-[60px] h-auto shadow-md pb-6" : "top-[60px] h-0"
        )}
      >
